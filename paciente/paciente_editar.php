<?php
    ...
    $sentencia = $conn->prepare("UPDATE paciente SET nombre=?, cedula=?, fecha_nacimiento=? WHERE id=?");
    $sentencia->bind_param("sssi", $nombre, $cedula, $fecha_nacimiento, $id);
