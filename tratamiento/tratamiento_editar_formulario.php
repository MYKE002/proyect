<?php
    ...
    $sentencia = $conn->prepare("SELECT id, nombre, precio FROM tratamiento WHERE id = ?;");
...
<body>
    ...
    <div class="container mt-3">
        <h2>Editar Médico</h2>
        <form action="tratamiento_editar.php" method="post">
            ...
            <div class="mb-3 mt-3 col-2">
                ...
                <input type="text" value="<?php echo $precio ?>" class="form-control" name="precio" id="precio" required>
            </div>
